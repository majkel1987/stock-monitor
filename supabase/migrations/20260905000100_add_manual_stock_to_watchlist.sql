...
begin
  ...
  from public.markets
  where code = upper(btrim(p_market_code));
...
revoke all on function public.add_manual_stock_to_watchlist(text, text, text, uuid)
  from public, anon, authenticated;
grant execute on function public.add_manual_stock_to_watchlist(text, text, text, uuid)
  to authenticated;
